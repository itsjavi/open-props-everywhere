...
export const easings = {
  ...
  ease_2: { value: 'cubic-bezier(.25, 0, .4, 1)' },
  ease_3: { value: 'cubic-bezier(.25, 0, .3, 1)' },
  ease_4: { value: 'cubic-bezier(.25, 0, .2, 1)' },
  ease_5: { value: 'cubic-bezier(.25, 0, .1, 1)' },

  ease_in_1: { value: 'cubic-bezier(.25, 0, 1, 1)' },
  ease_in_2: { value: 'cubic-bezier(.50, 0, 1, 1)' },
  ease_in_3: { value: 'cubic-bezier(.70, 0, 1, 1)' },
  ease_in_4: { value: 'cubic-bezier(.90, 0, 1, 1)' },
  ease_in_5: { value: 'cubic-bezier(1, 0, 1, 1)' },

  ease_out_1: { value: 'cubic-bezier(0, 0, .75, 1)' },
  ease_out_2: { value: 'cubic-bezier(0, 0, .50, 1)' },
  ease_out_3: { value: 'cubic-bezier(0, 0, .3, 1)' },
  ease_out_4: { value: 'cubic-bezier(0, 0, .1, 1)' },
  ease_out_5: { value: 'cubic-bezier(0, 0, 0, 1)' },

  ease_in_out_1: { value: 'cubic-bezier(.1, 0, .9, 1)' },
  ease_in_out_2: { value: 'cubic-bezier(.3, 0, .7, 1)' },
  ease_in_out_3: { value: 'cubic-bezier(.5, 0, .5, 1)' },
  ease_in_out_4: { value: 'cubic-bezier(.7, 0, .3, 1)' },
  ease_in_out_5: { value: 'cubic-bezier(.9, 0, .1, 1)' },

  ease_elastic_out_1: { value: 'cubic-bezier(.5, .75, .75, 1.25)' },
  ease_elastic_out_2: { value: 'cubic-bezier(.5, 1, .75, 1.25)' },
  ease_elastic_out_3: { value: 'cubic-bezier(.5, 1.25, .75, 1.25)' },
  ease_elastic_out_4: { value: 'cubic-bezier(.5, 1.5, .75, 1.25)' },
  ease_elastic_out_5: { value: 'cubic-bezier(.5, 1.75, .75, 1.25)' },

  ease_elastic_in_1: { value: 'cubic-bezier(.5, -0.25, .75, 1)' },
  ease_elastic_in_2: { value: 'cubic-bezier(.5, -0.50, .75, 1)' },
  ease_elastic_in_3: { value: 'cubic-bezier(.5, -0.75, .75, 1)' },
  ease_elastic_in_4: { value: 'cubic-bezier(.5, -1.00, .75, 1)' },
  ease_elastic_in_5: { value: 'cubic-bezier(.5, -1.25, .75, 1)' },

  ease_elastic_in_out_1: { value: 'cubic-bezier(.5, -.1, .1, 1.5)' },
  ease_elastic_in_out_2: { value: 'cubic-bezier(.5, -.3, .1, 1.5)' },
  ease_elastic_in_out_3: { value: 'cubic-bezier(.5, -.5, .1, 1.5)' },
  ease_elastic_in_out_4: { value: 'cubic-bezier(.5, -.7, .1, 1.5)' },
  ease_elastic_in_out_5: { value: 'cubic-bezier(.5, -.9, .1, 1.5)' },

  ease_step_1: { value: 'steps(2)' },
  ease_step_2: { value: 'steps(3)' },
  ease_step_3: { value: 'steps(4)' },
  ease_step_4: { value: 'steps(7)' },
  ease_step_5: { value: 'steps(10)' },
