export const easings = {
  ease_1: 'cubic-bezier(.25, 0, .5, 1)',
  ease_2: 'cubic-bezier(.25, 0, .4, 1)',
  ease_3: 'cubic-bezier(.25, 0, .3, 1)',
  ease_4: 'cubic-bezier(.25, 0, .2, 1)',
  ease_5: 'cubic-bezier(.25, 0, .1, 1)',

  ease_in_1: 'cubic-bezier(.25, 0, 1, 1)',
  ease_in_2: 'cubic-bezier(.50, 0, 1, 1)',
  ease_in_3: 'cubic-bezier(.70, 0, 1, 1)',
  ease_in_4: 'cubic-bezier(.90, 0, 1, 1)',
  ease_in_5: 'cubic-bezier(1, 0, 1, 1)',

  ease_out_1: 'cubic-bezier(0, 0, .75, 1)',
  ease_out_2: 'cubic-bezier(0, 0, .50, 1)',
  ease_out_3: 'cubic-bezier(0, 0, .3, 1)',
  ease_out_4: 'cubic-bezier(0, 0, .1, 1)',
  ease_out_5: 'cubic-bezier(0, 0, 0, 1)',

  ease_in_out_1: 'cubic-bezier(.1, 0, .9, 1)',
  ease_in_out_2: 'cubic-bezier(.3, 0, .7, 1)',
  ease_in_out_3: 'cubic-bezier(.5, 0, .5, 1)',
  ease_in_out_4: 'cubic-bezier(.7, 0, .3, 1)',
  ease_in_out_5: 'cubic-bezier(.9, 0, .1, 1)',

  ease_elastic_out_1: 'cubic-bezier(.5, .75, .75, 1.25)',
  ease_elastic_out_2: 'cubic-bezier(.5, 1, .75, 1.25)',
  ease_elastic_out_3: 'cubic-bezier(.5, 1.25, .75, 1.25)',
  ease_elastic_out_4: 'cubic-bezier(.5, 1.5, .75, 1.25)',
  ease_elastic_out_5: 'cubic-bezier(.5, 1.75, .75, 1.25)',

  ease_elastic_in_1: 'cubic-bezier(.5, -0.25, .75, 1)',
  ease_elastic_in_2: 'cubic-bezier(.5, -0.50, .75, 1)',
  ease_elastic_in_3: 'cubic-bezier(.5, -0.75, .75, 1)',
  ease_elastic_in_4: 'cubic-bezier(.5, -1.00, .75, 1)',
  ease_elastic_in_5: 'cubic-bezier(.5, -1.25, .75, 1)',

  ease_elastic_in_out_1: 'cubic-bezier(.5, -.1, .1, 1.5)',
  ease_elastic_in_out_2: 'cubic-bezier(.5, -.3, .1, 1.5)',
  ease_elastic_in_out_3: 'cubic-bezier(.5, -.5, .1, 1.5)',
  ease_elastic_in_out_4: 'cubic-bezier(.5, -.7, .1, 1.5)',
  ease_elastic_in_out_5: 'cubic-bezier(.5, -.9, .1, 1.5)',

  ease_step_1: 'steps(2)',
  ease_step_2: 'steps(3)',
  ease_step_3: 'steps(4)',
  ease_step_4: 'steps(7)',
  ease_step_5: 'steps(10)',

  ease_spring_1: `linear(
    0, 0.006, 0.025 2.8%, 0.101 6.1%, 0.539 18.9%, 0.721 25.3%, 0.849 31.5%,
    0.937 38.1%, 0.968 41.8%, 0.991 45.7%, 1.006 50.1%, 1.015 55%, 1.017 63.9%,
    1.001
  )`,
  ease_spring_2: `linear(
